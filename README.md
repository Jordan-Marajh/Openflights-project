...
2. Run the [Openflights Cleaning Notebook](Openflights-project\openflights_cleaning.ipynb) to clean the data ready for importing into SQL

3. Run [SQL build file](openflights_build.sql) to create the database and import data
